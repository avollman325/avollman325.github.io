...
var sum = function(array) {
  //base case: want to make sure there is something in the array
  
  if(array.length === 0 ){//if the array is empty it will return 0 
    return 0;
...
var powerOfTwo = function(n) {
  if (n === 1 ){return true}//if n === 1 that means its a power of 2
  else if( n < 1  ){return false}//if it is less than 1 then is not a power
  else{return powerOfTwo(n / 2)}//the will keep dividing n until its either 1 or less than 1
};

// 9. Write a function that accepts a string a reverses it.
var reverse = function(string) {
  if(string.length === 0 ){return ""}
  else {return string[string.length - 1] + reverse(string.substr(0,string.length - 1))}
...
var countOccurrence = function(array, value) {
  ...
  else {return (array[0] === value) + countOccurrence(array.slice(1), value)}
...
//(array[0] === value) + countOccurrence(array.slice(1), value)
